...
By accessing and using HashChat, you agree to be bound by these Terms of Service. If you do not agree to these terms, please do not use this application.
...
By using HashChat, you acknowledge that you:
...
HashChat is provided for:
- ✅ Legal communication between individuals
- ✅ Private conversations
- ✅ Temporary chat rooms for legitimate purposes

### 3. Prohibited Uses

You agree NOT to use HashChat for:

| Category | Examples |
|----------|----------|
| **Illegal Activities** | Hacking, fraud, theft, harassment |
| **Harmful Content** | Malware, viruses, spam |
| **Harassment** | Bullying, threats, hate speech |
| **Privacy Violations** | Sharing private info without consent |
| **Commercial Spam** | Unsolicited advertisements |
...
- **No Guarantee**: We don't guarantee the service will always be available
- **No Uptime**: Service may be interrupted without notice
- **No Support**: This is a free, as-is service
...
- User misconduct or illegal actions
...
- Legal fees
 ...
 arising from your use of HashChat or violation of these terms.
...
**DO NOT** engage. Report it instead.
...
*By using HashChat, you agree to these terms. Use responsibly.*
